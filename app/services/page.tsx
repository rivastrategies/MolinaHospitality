...
export const metadata: Metadata = { title: "Restaurant Consulting Services", description: "Restaurant operations consulting, executive search and management recruitment, fractional COO leadership, turnarounds, openings, profitability, training, and multi-unit support.", alternates: { canonical: "/services" } };
