...
const organizationSchema = {
  ...
  "@graph": [
    { "@type": "Organization", "@id": `${site.url}/#organization`, name: site.name, url: site.url, description: site.description, knowsAbout: ["Restaurant operations", "Restaurant executive search", "Restaurant management recruitment", "Multi-unit restaurant operations", "Restaurant leadership", "Restaurant profitability", "Restaurant turnarounds", "Restaurant openings"], hasOfferCatalog: { "@type": "OfferCatalog", name: "Restaurant Operations Consulting Services", itemListElement: services.map((service) => ({ "@type": "Offer", itemOffered: { "@type": "Service", name: service.name, url: `${site.url}/services/${service.slug}` } })) } },
    { "@type": "ProfessionalService", "@id": `${site.url}/#service`, name: site.name, url: site.url, description: site.description, areaServed: [{ "@type": "State", name: "Texas" }, { "@type": "Place", name: "Gulf Coast" }], serviceType: ["Restaurant Operations Consulting", "Restaurant Executive Search", "Restaurant Management Recruitment", "Fractional COO Services", "Restaurant Leadership Development", "Restaurant Profitability Improvement"] },
