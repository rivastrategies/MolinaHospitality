export const site = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL ?? "https://jimmolina.com",
};
...
export const services: Service[] = [
  ...
  makeService("restaurant-executive-search", "Restaurant Executive Search & Management Recruitment", "Find leaders who can operate", "Recruit proven restaurant management and executive talent for roles where leadership quality directly affects performance.", ["A critical management or executive role is vacant", "Candidate volume is high but operating fit is weak", "The role, authority, or success measures are unclear", "Urgency is creating pressure to compromise on the hire"], ["Leadership role scorecard and market positioning", "Targeted search and confidential candidate outreach", "Operating-experience screening and calibrated shortlist", "Structured interview and selection framework", "Reference diligence and transition planning"], ["Stronger alignment between the role and the business need", "A more focused and defensible selection process", "Less ownership time spent sorting unqualified candidates", "A stronger restaurant leadership bench"], ["Independent restaurant owners", "Multi-unit restaurant groups", "New restaurant openings", "Investor-backed hospitality organizations"], ["leadership-development", "executive-coaching", "multi-unit-operations", "new-restaurant-openings"]),
